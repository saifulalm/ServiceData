...
//        02140400001014384104
    ...
    {
        event(new CallbackEvent($request->input()));
        event(new CallbackEvent($request->query()));
        event(new CallbackEvent($request->schemeAndHttpHost()));
        event(new CallbackEvent($request->httpHost()));
